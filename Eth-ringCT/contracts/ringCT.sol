...
contract ringCT {
    ...
    // 
    function verify(string memory message, string memory infos, uint256[2] memory pkDim, bytes32[2][] memory pkB, bytes32 c0, uint256[2] memory ssDim, bytes32[] memory ssB, uint256 IIX, bytes32[2][] memory IIB, uint256[2] memory Cdim, uint256[2][] memory CiArray, uint256[2][] memory L1Array, uint256[] memory s2Array, uint256[] memory sArray) public {
        // verifySignature(string message, uint256 pkX, uint256 pkY, bytes32[2][] memory pkB, bytes32 c0, uint256 ssX, uint256 ssY, bytes32[] ssB, uint256 IIX, bytes32[2][] IIB)
    ...
    function verifyRangeProofs(uint256[2] memory Cdim, uint256[2][] memory CiArray, uint256[2][] memory  L1Array, uint256[] memory s2Array, uint256[] memory sArray) public returns (bool res) {
        uint256 Cx = Cdim[0];
        uint256 Cy = Cdim[1];
    ...
    function verifySignature(string memory message, uint256[2] memory pkDim, bytes32[2][] memory pkB, bytes32 c0, uint256[2] memory ssDim, bytes32[] memory ssB, uint256 IIX, bytes32[2][] memory IIB) public returns (bool) {
    ...
    function convertPK(bytes32[2][] memory pkB) internal returns (pubKey[100] memory) {
    ...
    function convertSS(bytes32[] memory ssB) internal returns (uint256[100] memory) {
    ...
    function pubKeyConverter(bytes32[2] memory p) internal returns (pubKey memory) {
    ...
    function verifyMLSAG(string memory messageString, uint256 pkX, uint256 pkY, pubKey[100] memory km, mgSig memory mg) internal returns (bool) {
    ...
    // mg: the mgSig to use
    function calculateC (string memory messageString, uint256[3] memory restOfStuff, pubKey[100] memory km, mgSig memory mg) internal returns (uint256 c) {
    ...
    function L1 (uint256 j, uint256[3] memory restOfStuff, mgSig memory mg) internal returns (uint256[3] memory res) {
        GA = [Gx, Gy];
        G = pubKey(GA);
    ...
    function L2 (uint256 j, uint256[3] memory restOfStuff, pubKey[100] memory km) internal returns (uint256[3] memory res) {
    ...
    function R2 (uint256 j, uint256[3] memory restOfStuff, mgSig memory mg) internal returns (uint256[3] memory res) {
    ...
    // s2: TODO
    // s: TODO
    function verifiy_ASNL(uint256 P1x, uint256[2][] memory P1, uint256[2][] memory P2, uint256[2][] memory L1, uint256[] memory s2, uint256 s) public returns (bool) {
    ...
    function ecadd(uint256[3] memory P, uint256[3] memory Q) public returns (uint256[3] memory R) {
    ...
    function ecaddmul(uint256[3] memory P1, uint256 d1, uint256[3] memory P2, uint256 d2) view private returns (uint256[3] memory R) {
    ...
    //formula from https://en.wikibooks.org/wiki/Cryptography/Prime_Curve/Jacobian_Coordinates
    function ecdouble(uint256[3] memory P) private view returns(uint256[3] memory R){
    ...
    function invmod(uint256 a, uint p) private view returns(uint256 invA) {
        uint256 t=0;
        uint256 newT=1;
        uint256 r=p;
        uint256 newR=a;
